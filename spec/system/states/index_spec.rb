...
RSpec.describe "states/index" do
  it "lists states with link to search by state" do
    ...
    mechanic = create(:occupation_standard, :with_data_import, title: "Mechanic", registration_agency: wa_reg_agency)
    create(:occupation_standard, :with_data_import, :program_standard, title: "Pipe Fitter", registration_agency: al_reg_agency)
