...
RSpec.describe StandardsImport, type: :model do
  ...
  describe ".manual_submissions_during_period" do
    it "returns only standards imports with conversions during the period" do
      standards_import_1 = create(:standards_import)
      create(:imports_uncategorized, parent: standards_import_1, processed_at: 3.months.ago)
      standards_import_2 = create(:standards_import)
      create(:imports_uncategorized, parent: standards_import_2, processed_at: 3.months.ago)
      create(:imports_uncategorized, parent: standards_import_2, processed_at: 6.weeks.ago)
      standards_import_3 = create(:standards_import)
      create(:imports_uncategorized, parent: standards_import_3, processed_at: 6.weeks.ago)
      create(:imports_uncategorized, parent: standards_import_3, processed_at: 1.week.ago)
      standards_import_4 = create(:standards_import)
      create(:imports_uncategorized, parent: standards_import_4, processed_at: 1.week.ago)

      expect(
        described_class.manual_submissions_during_period(date_range: 2.months.ago..1.month.ago)
      ).to match_array [standards_import_2, standards_import_3]
    end
  end
