...
RSpec.describe "admin/data_imports/show.html.erb", type: :view do
  it "displays description and links", :admin do
    ...
    expect(rendered).to have_link("Edit data import", href: edit_admin_source_file_data_import_path(source_file, data_import))
  ...
  it "displays link to occupation standard if it exists" do
    ...
    expect(rendered).to have_link("Mechanic", href: admin_occupation_standard_path(occupation_standard))
  end
end
