...
RSpec.describe "layouts/_header.html.erb", type: :view do
  it "has the expected navigation links" do
    ...
    expect(rendered).to have_css "a[href='#{admin_source_files_path}']", text: "Source files"
    expect(rendered).to have_css "a[href='#{admin_occupation_standards_path}']", text: "Occupation Standards"
